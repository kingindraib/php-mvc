...
<div class="container-md">
    <div class="row">
        ...
        <div class="col-md-6 m-auto">
            ...
            <form action="<?php echo e(url('admin/dashboard/category/store')); ?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo e(Form::formgroup('Category Name','text','category_name','','',old('category_name'))); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\php xampp\xampp second\htdocs\movie\views/admin/settings/category/create.blade.php ENDPATH**/ ?>