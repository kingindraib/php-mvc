...
<div class="container-md">
    <div class="row">
        ...
        <div class="col-md-6 m-auto">
            ...
            <form action="<?php echo e(url('admin/dashboard/movie/settngs/screen/update'.$data['id'])); ?>" method="POST">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo e(Form::formgroup('Screen Name','text','screen_name','','',$data['screen_name'])); ?>

                    </div>
                    <div class="col-md-12">
                        <?php echo e(Form::formgroup('Rows','text','seat_rows','','',$data['seat_rows'])); ?>

                    </div>
                    <div class="col-md-12">
                        <?php echo e(Form::formgroup('Columns','text','seat_columns','','',$data['seat_columns'])); ?>

                    </div>
                    <div class="col-md-12">
                        <label for="">Select Threator</label>
                        <select name="threator_code" id="" class="form-control my-2" required>
                            <option value="<?php echo e($data['threator_code']); ?>"><?php echo e(threator_code($data['threator_code'])->threator_name); ?></option>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\php xampp\xampp second\htdocs\movie\views/admin/movie_settings/screen/edit.blade.php ENDPATH**/ ?>