           ...
           <div class="card">
            ...
            <form action="<?php echo e(url('register/submit')); ?>" method="POST">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <?php echo e(Form::formgroup('Last Name','text','last_name','','',old('last_name'))); ?>

                    </div>
                    <div class="col-md-12">
                        <?php echo e(Form::formgroup('Phone','phone','phone','','',old('phone'))); ?>

                    </div>
                   <div class="col-md-12">
                    <?php echo e(Form::formgroup('Email','email','email','','',old('email'))); ?>

                   </div>
                   <div class="col-md-12">
                    <?php echo e(Form::formgroup('Date of Birth','date','birth','','',old('birth'))); ?>
                   ...
                   <div class="col-md-6 text-right mt-4">
                    <a href="<?php echo e(url('login')); ?>" class="register_section">Login Now</a>
                   </div>
                </div>
            </form>
           </div>
