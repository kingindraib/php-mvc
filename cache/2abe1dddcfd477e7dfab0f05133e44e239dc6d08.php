...
<div class="container-md">
    <div class="row">
        ...
        <div class="col-md-12 m-auto">
            ...
            <form action="<?php echo e(url('admin/dashboard/post_management/update/'.$data->id)); ?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-8">
                        <?php echo e(Form::formgroup('Post Title','text','title','','',$data->title)); ?>
                       ...
                       <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="editor" cols="30" rows="10" class="form-control"><?php echo e($data->description); ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
                                <input class="form-control" type="file" id="" onchange="imagepreview()" name="image">
                                <img id="imagepriview" src="<?php echo e(url($data->image)); ?>" class="ib-img" width="100%">
                           </div>
                        </div>
                       </div>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\php xampp\xampp second\htdocs\movie\views/admin/settings/post/edit.blade.php ENDPATH**/ ?>