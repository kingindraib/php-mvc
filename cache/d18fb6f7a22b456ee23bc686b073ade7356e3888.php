    ...
    <div class="row">
        ...
        <div class="col-md-6 m-auto">
            ...
            <form action="<?php echo e(url('admin/dashboard/movie/settngs/show/store')); ?>" method="POST">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo e(Form::formgroup('Show Name','text','show_name','','',old('show_name'))); ?>

                    </div>
                    <div class="col-md-12">
                        <?php echo e(Form::formgroup('show prize','text','show_prize','','',old('show_prize'))); ?>

                    </div>
                    <div class="col-md-12">
                        <?php echo e(Form::formgroup('offer prize','text','offer_prize','','',old('offer_prize'))); ?>

                    </div>
                    <div class="col-md-12">
                        <?php echo e(Form::formgroup('show time','time','show_time','','',old('show_time'))); ?>

                    </div>
                    <div class="col-md-12">
                        <?php echo e(Form::formgroup('show duretion','text','show_duration','','',old('show_duration'))); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\php xampp\xampp second\htdocs\movie\views/admin/movie_settings/shows/create.blade.php ENDPATH**/ ?>