...
@section('page_title','Assign threator Create')
@section('body')
@php
...
<div class="container-md">
    <div class="row my-3">
        <div class="col-md-8 m-auto">
			...
			<form action="{{url('admin/dashboard/movie/assign/store/')}}" method="POST">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <select name="screen_code" id="screen_id" class="form-control">
                                ...
                                @foreach(threator_screen($data->threator_code) as $screen)
