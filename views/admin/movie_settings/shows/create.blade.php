    ...
    <div class="row">
        ...
        <div class="col-md-6 m-auto">
            ...
            <form action="{{ url('admin/dashboard/movie/settngs/show/store') }}" method="POST">
                <div class="row">
                    <div class="col-md-12">
                        {{Form::formgroup('Show Name','text','show_name','','',old('show_name'))}}
                    </div>
                    <div class="col-md-12">
                        {{Form::formgroup('show prize','text','show_prize','','',old('show_prize'))}}
                    </div>
                    <div class="col-md-12">
                        {{Form::formgroup('offer prize','text','offer_prize','','',old('offer_prize'))}}
                    </div>
                    <div class="col-md-12">
                        {{Form::formgroup('show time','time','show_time','','',old('show_time'))}}
                    </div>
                    <div class="col-md-12">
                        {{Form::formgroup('show duretion','text','show_duration','','',old('show_duration'))}}
                    </div>
                    <div class="col-md-12">
