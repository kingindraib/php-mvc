...
<div class="container-md">
    <div class="row">
        ...
        <div class="col-md-6 m-auto">
            ...
            <form action="{{ url('admin/dashboard/category/store') }}" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                        {{Form::formgroup('Category Name','text','category_name','','',old('category_name'))}}
                    </div>
                    <div class="col-md-12">
