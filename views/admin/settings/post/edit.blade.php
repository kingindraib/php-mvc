...
<div class="container-md">
    <div class="row">
        ...
        <div class="col-md-12 m-auto">
            ...
            <form action="{{ url('admin/dashboard/post_management/update/'.$data->id) }}" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-8">
                        {{Form::formgroup('Post Title','text','title','','',$data->title)}}
                    </div>
                    <div class="col-md-4">
                       ...
                       <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="editor" cols="30" rows="10" class="form-control">{{ $data->description }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
                                <input class="form-control" type="file" id="" onchange="imagepreview()" name="image">
                                <img id="imagepriview" src="{{ url($data->image) }}" class="ib-img" width="100%">
                           </div>
                        </div>
                       </div>
                    </div>
